...
function showView(name) {
  const valid = ["home", "days", "gallery", "timeline", "reasons", "dreams", "nazar", "punish", "universe", "openwhen", "angry", "kilometer", "secret"];
...
function openLetter(day, letter) {
  ...
  // Day 25 and Day 26 get the premium Apple-style voice player (real audio,
  // waveform, progress, duration) instead of the plain "Play Voice Note" pill
  // used by every other letter. Every other day is completely untouched.
